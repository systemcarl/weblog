...
# DevLog: CI/CD for a Modern (SvelteKit) Web Application
- I have been [building a SvelteKit application] for my [personal portfolio] and
    weblog.
    - The application is a template [server-side rendered (SSR)] web application
        that is [populated using static JSON files].
...
- Generally, this project was a success.
...
[TLS termination]: https://en.wikipedia.org/wiki/Transport_Layer_Security#TLS_termination
...
[Actions]: https://docs.github.com/en/actions/creating-actions/creating-a-javascript-action
